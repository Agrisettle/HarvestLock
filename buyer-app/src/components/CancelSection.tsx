 ...
 * `primaryAction()` in `CommitmentDetail.tsx` — cancellation is available
 * across many states at once, not tied to a single next-required step the
 * way lock/settle are, and it has its own multi-step state machine
 * (propose → approve → finalize) that doesn't fit that button's shape.
 */
