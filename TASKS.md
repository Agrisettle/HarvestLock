...
Current state: happy-path state machine + claimable-balance-with-expiry + mutual cancellation + buyer-position assignability, 34/34 tests, testnet-verified four times. Next, in priority order (matches the contracts repo's own `HANDOFF.md`):
